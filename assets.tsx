...
export function getAsset(type: ToastTypes | undefined): VNode | null {
    switch (type) {
...
export function Loader(props: { visible: boolean, class?: string }) {
    return <div class={cx("sonner-loading-wrapper", props.class)} data-visible={props.visible}>
        <div class="sonner-spinner">
            {bars.map((_, i) => <div class="sonner-loading-bar" key={`spinner-bar-${i}`}/>)}
        </div>
    </div>
};
